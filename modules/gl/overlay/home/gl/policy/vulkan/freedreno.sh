...
GLIBC_FREEDRENO_ICD="$HOME/gl/opt/mesa-glibc/share/vulkan/icd.d/freedreno_icd.aarch64.json"

if [ -r "$GLIBC_FREEDRENO_ICD" ]; then
    export VK_ICD_FILENAMES="$GLIBC_FREEDRENO_ICD"
    export VK_DRIVER_FILES="$GLIBC_FREEDRENO_ICD"
