...
def main() -> None:
    ...
    claims.extend([
        ...
        },
        {
            ...
            'remaining_gap': 'TARGET_POPULATION_INTERVENTION_LIFT;EXACT_RETAINED_SUPPLY_BYTE_AND_ARCHIVE_MEMBER_BINDING;MATERIALIZER_DESIGN_REVIEW',
            'minimum_closure_action': 'REVIEW_TARGET_POPULATION_INTERVENTION_LIFT_AND_SUPPLY_BYTE_BINDING_WITHOUT_IMPLEMENTATION_OR_POPULATION',
            ...
            'classification_state': 'BOUNDED_TARGET_POLICY_ACCEPTED_POPULATION_BLOCKED',
            'authority_effect': 'NO_TARGET_POPULATION_OR_ACTIVATION_EFFECT',
            'prohibited_inference': 'TARGET_POLICY_ACCEPTANCE_DOES_NOT_BIND_SUPPLY_BYTES_AUTHORIZE_MATERIALIZER_IMPLEMENTATION_OR_POPULATE_TARGET_PATHS',
        },
        {
