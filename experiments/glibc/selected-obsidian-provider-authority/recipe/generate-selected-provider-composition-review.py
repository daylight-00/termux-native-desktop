...
def main():
 ...
 # exact FreeType selected Pango/GTK font engine provider
 x=read(review/'freetype-bounded-provider-authority.tsv')[0];member=bn(x['exact_member_path']);soname=x['observed_soname']
 rows.append(dict(composition_row_id='COMP-FREETYPE-PROV-001',provider_review_id=x['review_id'],recipe_root=x['recipe_root'],artifact_package=x['artifact_package'],artifact_version=x['artifact_version'],member_basename=member,member_sha256=x['exact_member_sha256'],soname=soname,alias_basename=soname,alias_target_basename=member,capability_scope=x['consumer_scope'],composition_inclusion='INCLUDED_SELECTED_GTK_SCOPE',inclusion_reason='EXACT_SELECTED_PANGO_FT2_AND_GTK_FONT_ENGINE_PROVIDER_DECISION',collision_state='NO_ACCEPTED_MEMBER_OR_ALIAS_COLLISION_STATIC_DEV_AND_ORACLE_BYTES_EXCLUDED',update_boundary=x['update_boundary'],rollback_boundary=x['rollback_boundary'],authority_effect='MEMBER_AND_SONAME_ALIAS_PROPOSED_ONLY_NO_TARGET_POPULATION',prohibited_inference=x['prohibited_inference']))
 # exact conditional transitive members included only for FreeType feature closure
 for x in read(review/'freetype-transitive-provider-authority.tsv'):
  member=bn(x['exact_member_path']);soname=x['observed_soname']
  rows.append(dict(composition_row_id=f"COMP-{x['review_id']}",provider_review_id=x['review_id'],recipe_root=x['recipe_root'],artifact_package=x['artifact_package'],artifact_version=x['artifact_version'],member_basename=member,member_sha256=x['exact_member_sha256'],soname=soname,alias_basename=soname,alias_target_basename=member,capability_scope=x['consumer_scope'],composition_inclusion='INCLUDED_TRANSITIVE_FREETYPE_SCOPE',inclusion_reason=x['inclusion_reason'],collision_state='NO_ACCEPTED_MEMBER_OR_ALIAS_COLLISION_EXACT_CONDITIONAL_OBJECT_ONLY',update_boundary=x['update_boundary'],rollback_boundary=x['rollback_boundary'],authority_effect='MEMBER_AND_SONAME_ALIAS_PROPOSED_ONLY_NO_TARGET_POPULATION',prohibited_inference=x['prohibited_inference']))
 # exact libxkbcommon selected GTK Wayland keymap and keyboard provider
 x=read(review/'libxkbcommon-bounded-provider-authority.tsv')[0];member=bn(x['exact_member_path']);soname=x['observed_soname']
 rows.append(dict(composition_row_id='COMP-LIBXKBCOMMON-PROV-001',provider_review_id=x['review_id'],recipe_root=x['recipe_root'],artifact_package=x['artifact_package'],artifact_version=x['artifact_version'],member_basename=member,member_sha256=x['exact_member_sha256'],soname=soname,alias_basename=soname,alias_target_basename=member,capability_scope=x['consumer_scope'],composition_inclusion='INCLUDED_SELECTED_GTK_SCOPE',inclusion_reason='EXACT_SELECTED_GTK_WAYLAND_XKB_KEYMAP_AND_KEYBOARD_PROVIDER_DECISION',collision_state='NO_ACCEPTED_MEMBER_OR_ALIAS_COLLISION_OLD_CONCRETE_LABEL_DEV_ALIAS_SIBLINGS_AND_ORACLE_BYTES_EXCLUDED',update_boundary=x['update_boundary'],rollback_boundary=x['rollback_boundary'],authority_effect='MEMBER_AND_SONAME_ALIAS_PROPOSED_ONLY_NO_TARGET_POPULATION',prohibited_inference=x['prohibited_inference']))
 # exact HarfBuzz selected Pango core OpenType shaping provider
 x=read(review/'harfbuzz-bounded-provider-authority.tsv')[0];member=bn(x['exact_member_path']);soname=x['observed_soname']
 rows.append(dict(composition_row_id='COMP-HARFBUZZ-PROV-001',provider_review_id=x['review_id'],recipe_root=x['recipe_root'],artifact_package=x['artifact_package'],artifact_version=x['artifact_version'],member_basename=member,member_sha256=x['exact_member_sha256'],soname=soname,alias_basename=soname,alias_target_basename=member,capability_scope=x['consumer_scope'],composition_inclusion='INCLUDED_SELECTED_GTK_SCOPE',inclusion_reason='EXACT_SELECTED_PANGO_CORE_OPENTYPE_SHAPING_PROVIDER_DECISION',collision_state='NO_ACCEPTED_MEMBER_OR_ALIAS_COLLISION_NEWER_CONCRETE_LABEL_DEV_ALIAS_SIBLINGS_SUBPACKAGES_AND_ORACLE_BYTES_EXCLUDED',update_boundary=x['update_boundary'],rollback_boundary=x['rollback_boundary'],authority_effect='MEMBER_AND_SONAME_ALIAS_PROPOSED_ONLY_NO_TARGET_POPULATION',prohibited_inference=x['prohibited_inference']))
 # exact Fontconfig selected Pango font discovery and matching provider
 x=read(review/'fontconfig-bounded-provider-authority.tsv')[0];member=bn(x['exact_member_path']);soname=x['observed_soname']
 rows.append(dict(composition_row_id='COMP-FONTCONFIG-PROV-001',provider_review_id=x['review_id'],recipe_root=x['recipe_root'],artifact_package=x['artifact_package'],artifact_version=x['artifact_version'],member_basename=member,member_sha256=x['exact_member_sha256'],soname=soname,alias_basename=soname,alias_target_basename=member,capability_scope=x['consumer_scope'],composition_inclusion='INCLUDED_SELECTED_GTK_SCOPE',inclusion_reason='EXACT_SELECTED_PANGO_FONT_DISCOVERY_MATCHING_AND_PATTERN_PROVIDER_DECISION',collision_state='NO_ACCEPTED_MEMBER_OR_ALIAS_COLLISION_OLDER_CONCRETE_LABEL_DEV_ALIAS_PACKAGE_DEFAULT_CONFIG_GLOBAL_CACHE_TOOLS_AND_ORACLE_BYTES_EXCLUDED',update_boundary=x['update_boundary'],rollback_boundary=x['rollback_boundary'],authority_effect='MEMBER_AND_SONAME_ALIAS_PROPOSED_ONLY_NO_TARGET_POPULATION',prohibited_inference=x['prohibited_inference']))
 # exact Pixman selected identity included only as Cairo pixel-compositing prerequisite
 x=read(review/'pixman-cairo-prerequisite-provider-authority.tsv')[0];member=bn(x['exact_member_path']);soname=x['observed_soname']
 rows.append(dict(composition_row_id='COMP-PIXMAN-CAIRO-PREQ-PROV-001',provider_review_id=x['review_id'],recipe_root=x['recipe_root'],artifact_package=x['artifact_package'],artifact_version=x['artifact_version'],member_basename=member,member_sha256=x['exact_member_sha256'],soname=soname,alias_basename=bn(x['observed_alias_path']),alias_target_basename=bn(x['observed_alias_target']),capability_scope=x['consumer_scope'],composition_inclusion='INCLUDED_SELECTED_GTK_SCOPE',inclusion_reason='EXACT_SELECTED_PIXMAN_PROVIDER_REQUIRED_BY_EXACT_CAIRO_DT_NEEDED',collision_state='NO_ACCEPTED_MEMBER_OR_ALIAS_COLLISION_OLDER_REFERENCE_BYTES_DEV_ALIAS_ACCELERATION_AND_PACKAGE_WIDE_SURFACES_EXCLUDED',update_boundary=x['update_boundary'],rollback_boundary=x['rollback_boundary'],authority_effect='MEMBER_AND_SONAME_ALIAS_PROPOSED_ONLY_NO_CAIRO_PROVIDER_OR_TARGET_POPULATION',prohibited_inference=x['prohibited_inference']))
 # exact Graphite2 prerequisite for the Graphite-enabled HarfBuzz shaping path
 x=read(review/'graphite2-harfbuzz-prerequisite-provider-authority.tsv')[0];member=bn(x['exact_member_path']);soname=x['observed_soname']
 rows.append(dict(composition_row_id='COMP-GRAPHITE2-HARFBUZZ-PREQ-PROV-001',provider_review_id=x['review_id'],recipe_root=x['recipe_root'],artifact_package=x['artifact_package'],artifact_version=x['artifact_version'],member_basename=member,member_sha256=x['exact_member_sha256'],soname=soname,alias_basename=bn(x['observed_alias_path']),alias_target_basename=bn(x['observed_alias_target']),capability_scope=x['consumer_scope'],composition_inclusion='INCLUDED_SELECTED_GTK_SCOPE',inclusion_reason='EXACT_SELECTED_GRAPHITE2_PROVIDER_REQUIRED_BY_GRAPHITE_ENABLED_EXACT_HARFBUZZ_SHAPING_PATH',collision_state='NO_ACCEPTED_MEMBER_OR_ALIAS_COLLISION_DEV_ALIAS_TOOLS_TESTS_METADATA_PACKAGE_WIDE_SURFACES_AND_ORACLE_BYTES_EXCLUDED',update_boundary=x['update_boundary'],rollback_boundary=x['rollback_boundary'],authority_effect='MEMBER_AND_SONAME_ALIAS_PROPOSED_ONLY_NO_HARFBUZZ_WIDENING_COMPLETE_COMPOSITION_OR_TARGET_POPULATION',prohibited_inference=x['prohibited_inference']))
 # exact atomic Cairo core and Cairo-GObject provider pair
 x=read(review/'cairo-bounded-provider-authority.tsv')[0]
 paths=x['exact_member_paths'].split(';');shas=x['exact_member_sha256s'].split(';');sons=x['observed_sonames'].split(';');aliases=x['observed_alias_paths'].split(';');targets=x['observed_alias_targets'].split(';')
 if not (len(paths)==len(shas)==len(sons)==len(aliases)==len(targets)==2):raise SystemExit('Cairo accepted member list length mismatch')
 for i,(member_path,member_sha,soname,alias,target) in enumerate(zip(paths,shas,sons,aliases,targets),1):
  rows.append(dict(composition_row_id=f'COMP-CAIRO-PROV-001-{i}',provider_review_id=x['review_id'],recipe_root=x['recipe_root'],artifact_package=x['artifact_package'],artifact_version=x['artifact_version'],member_basename=bn(member_path),member_sha256=member_sha,soname=soname,alias_basename=bn(alias),alias_target_basename=bn(target),capability_scope=x['consumer_scope'],composition_inclusion='INCLUDED_SELECTED_GTK_SCOPE',inclusion_reason='ATOMIC_EXACT_CAIRO_CORE_AND_GOBJECT_PROVIDER_DECISION',collision_state='NO_ACCEPTED_MEMBER_OR_ALIAS_COLLISION_NEWER_REFERENCE_LABELS_DEV_ALIASES_UTILITIES_BACKENDS_AND_ORACLE_BYTES_EXCLUDED',update_boundary=x['update_boundary'],rollback_boundary=x['rollback_boundary'],authority_effect='MEMBER_AND_SONAME_ALIAS_PROPOSED_ONLY_NO_COMPLETE_COMPOSITION_OR_TARGET_POPULATION',prohibited_inference=x['prohibited_inference']))
 rows.sort(key=lambda r:r['composition_row_id'])
 if len(rows)!=36:raise SystemExit(f'expected 36 accepted member rows, got {len(rows)}')
 if len({r['soname'] for r in rows})!=36:raise SystemExit('accepted SONAME collision')
 if len({r['alias_basename'] for r in rows})!=36:raise SystemExit('accepted alias collision')
