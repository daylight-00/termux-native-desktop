...
> **State:** generic build-attestation and adaptation gap-evidence supply batch SUP-01 response REVIEWED / BOUNDED; OJ-001 now requires stable SONAME `libjpeg.so.62`, the incompatible `libjpeg.so.8` family remains rejected, one object-requirement correction is accepted, and provider authority and target population remain blocked
> **Updated:** 2026-07-14
...
AUTH-009 non-priority generic capabilities; SUP-01 review accepts stable required SONAME libjpeg.so.62 and rejects the WITH_JPEG8 SONAME-8 family as a substitute; OJ-001 is closed by requirement correction while matching provider supply, build-attestation, adaptation, filename-drift and final-provider decisions remain open
...
3. non-priority generic capability/source-class boundary: PASS / isolated P0 `SUP-01` response REVIEWED; OJ-001 required identity corrected to stable SONAME `libjpeg.so.62`, SONAME-8 substitution rejected and no matching provider bound; fulfill `SUP-02` producing-build provenance and output linkage NEXT;
