...
bundle-native documentation and operations control planes active; ADR 0005 claim classification complete; exact libxkbcommon accepted for bounded GTK Wayland XKB keymap and keyboard translation; selected-provider composition incomplete with 13 gaps; HarfBuzz review active
> **Updated:** 2026-07-17
...
- The selected-provider composition review now records 30 exact accepted members, includes 29 in the selected GTK/transitive scope, defers libtasn1 until a GnuTLS/security profile is selected, finds zero accepted-member SONAME or alias collisions, and identifies 13 unresolved selected GTK identities. The exact `libxkbcommon.so.0.8.0` member is accepted only for GTK 3.24.49 Wayland XKB context, keymap, state, modifier and keysym translation. The Class D composition decision remains `REVIEWED_BLOCKED_INCOMPLETE`; target-manifest generation, population and activation remain blocked while the next exact HarfBuzz provider tranche is reviewed.
