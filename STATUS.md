...
bundle-native documentation and operations control planes active; ADR 0005 claim classification complete with 93 separated claims; exact libXdamage and atomic AT-SPI2 core project candidates accepted as bounded GTK 3.24.49 providers; selected-provider composition incomplete with 3 unresolved identities; official GTK 3.24.49 source coordinate corrected; atomic GTK 3 core recipe/build design active; libSELinux blocker retained
> **Updated:** 2026-07-21
...
- The selected-provider composition review now records 40 exact accepted members, includes 39 in the selected GTK/transitive scope, defers libtasn1 until a GnuTLS/security profile is selected, finds zero accepted-member SONAME or alias collisions, and identifies 3 unresolved selected GTK identities. Exact project-produced libXdamage retains bounded GTK 3.24.49 GDK X11 damage-extension authority. The exact atomic ATK, ATK-bridge and AT-SPI three-member family now has bounded authority only for selected GTK 3.24.49 accessibility library linkage; its seven activation metadata files remain disabled, its two helpers remain non-executed, and no D-Bus bus, registry-daemon, accessibility enablement, service, target or activation authority is accepted. The GTK 3.24.49 source coordinate is corrected to official tag object `9003f198803b9b8b1d7def25a2359f8ebb4b25cf`, commit `198aeace1e9e119c77f4d669bd8efdf337828ad1`, and archive SHA-256 `a2958d82986c81794e953a3762335fa7c78948706d23cced421f7245ca544cbc`. The GDK/GTK core pair and `libselinux.so.1` remain no-candidate blockers. The Class D composition remains `REVIEWED_BLOCKED_INCOMPLETE`; target-manifest generation, population and activation remain blocked. The production-boundary decision activates atomic GTK 3 core candidate preparation next and withholds libSELinux build authorization pending direct-consumer necessity.
